          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Пароль"
                required
                className="w-full px-4 py-2.5 pr-12 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500"
              />
              <button
                type="button"
