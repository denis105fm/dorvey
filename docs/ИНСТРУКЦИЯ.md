...
![Общий поток: кампания → дорвеи и офферы → деплой](../assets/workflow-diagram.png)
...
> Добавьте скриншот: экран входа и дашборд после входа → сохраните как `docs/images/01-dashboard.png`
...
> Скриншот: Кампании → список и форма → `docs/images/02-campaigns.png`
...
> Скриншот: Дорвеи → список и модалка генерации → `docs/images/03-doorways.png`
...
> Скриншот: Офферы → таблица и импорт → `docs/images/04-offers.png`
...
> Скриншот: Настройки → обзор блоков → `docs/images/05-settings-overview.png`
...
| Поле | Назначение |
|------|------------|
| **Использовать внешние данные в аналитике** | Вкл/выкл использование NewsAPI и сезонности в расчётах и в блоке «Внешние данные по странам» на Дорвеях и в Рекомендациях |
| **NewsAPI.org API Key** | Ключ с newsapi.org для загрузки новостей по странам |
...
> Скриншот: Настройки → блок «Внешние данные для аналитики офферов» → `docs/images/06-settings-external.png`
...
> Скриншот: Настройки → блок интеграций (часть с ключами) → `docs/images/05-settings-integrations.png`
...
1. Настройки → «Внешние данные для аналитики офферов» → включить чекбокс, ввести NewsAPI API Key (и при необходимости URL сезонности).
